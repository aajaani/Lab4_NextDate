...
public class GTv2 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    ...
	    String string0 = nextDate0.run(10, 29, 1801);
	    assertEquals("10/30/1801", string0);
	}
	...
	public void testRunWithNegative() throws Throwable {
	    NextDate nextDate0 = new NextDate(2021, 2021, 2021);
	    String string0 = nextDate0.run(2021, (-791), 2021);
	    assertEquals("invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate8() throws Throwable {
	    ...
	    String string0 = nextDate0.run(7, 1, 1879);
	    assertEquals("7/1/1879", string0);
	}
