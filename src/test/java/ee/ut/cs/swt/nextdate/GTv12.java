...
public class GTv12 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    ...
	    String string0 = nextDate0.run(8, 8, 1973);
	    assertEquals("8/9/1973", string0);
	}
	...
	public void testRunWithPositive0() throws Throwable {
	    ...
	    String string0 = nextDate0.run(2021, 12, 3754);
	    assertEquals("invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate7() throws Throwable {
	    NextDate nextDate0 = new NextDate(1959, 1959, 1959);
	    String string0 = nextDate0.run(12, 12, 1959);
	    assertEquals("12/13/1959", string0);
	}
