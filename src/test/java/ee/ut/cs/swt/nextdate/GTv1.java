...
public class GTv1 {
	...
	public void testCreatesNextDate1() throws Throwable {
	    NextDate nextDate0 = new NextDate(1, 1, 1801);
	...
	public void testCreatesNextDate3() throws Throwable {
	    ...
	    String string0 = nextDate0.run(4, 31, 1970);
	    assertEquals("Invalid Input Date", string0);
	}
	...
	public void testCreatesNextDate5() throws Throwable {
	    ...
	    String string0 = nextDate0.run(9, 30, 1879);
	    assertEquals("10/1/1879", string0);
	}
	...
	public void testCreatesNextDate12() throws Throwable {
	    ...
	    String string0 = nextDate0.run(5, 30, 1872);
	    assertEquals("5/31/1872", string0);
	}
